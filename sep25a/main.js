...
var $author$project$Main$inOke = function (hiki) {
	return A3(
		$andrewMacmurray$elm_simple_animation$Simple$Animation$fromTo,
		{
			duration: 500,
		...
		_List_fromArray(
			[
				$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$rotate(-30),
				$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$x($author$project$Main$pondWidth + 150),
				$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(100 * hiki)
			]),
		_List_fromArray(
			[
				$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$rotate(30),
...
var $author$project$Main$tsukamaetaKingyoView2 = F2(
	function (hiki, kingyo) {
		var vy = kingyo.v.y;
		var vx = kingyo.v.x;
		var transtr = '(' + ($elm$core$String$fromInt(kingyo.pos.x) + (',' + ($elm$core$String$fromInt(kingyo.pos.y) + ')')));
		...
		return A3(
			$author$project$Main$animatedG,
			$author$project$Main$inOke(hiki),
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$transform(
					'rotate(' + (theta + (',' + ($elm$core$String$fromInt(px) + (',' + ($elm$core$String$fromInt(py) + (')' + ('translate' + transtr))))))))
										...
										_Utils_ap(
											...
											_Utils_ap(
												...
												_Utils_ap(
													...
													A2($elm$core$List$indexedMap, $author$project$Main$tsukamaetaKingyoView2, model.tsukamaeta)))))))))
					]);
			}
		}());
};
